...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    // Simulate submit (you can connect backend later)
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="contact-left">
            <h1 className="subti contact-title">Contact</h1>
            ...
            <div className="social-icons">
              <a href="https://wa.me/916396799414">
              ...
              <a href="https://telegram.me/aanchalgoyal">
            ...
            <a href="/documents/cv.pdf" className="btn btn2" download>
              Download CV
            </a>
          </div>
